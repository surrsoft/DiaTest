 ...
 * <p>
 * СТАРЫЕ НАЗВАНИЯ: [BuilderRL]
 * <p>
 * ВЕРСИЯ 2 1.1 2018-11-10 (stored)
 * ВЕРСИЯ 1 1.0 08.10.2016
 * <p>
 * #id [[w369w]]
 */
public class BuLayRelative_01 {
    private static final String TAG = ":" + BuLayRelative_01.class.getSimpleName();
    ...
    //constructors
    //``````````````````````````````````````````````````````````````````````````````````````````````
    public BuLayRelative_01(Context context) {
        mContext = context;
    ...
    public BuLayRelative_01 hWC() {
        mH_px = RelativeLayout.LayoutParams.WRAP_CONTENT;
        return this;
    }

    public BuLayRelative_01 ecudComment(String st) {
        mEcudComment = st;
        return this;
    }
     ...
     * @return
     */
    public BuLayRelative_01 addTo(ViewGroup parent) {
        mParentLay = parent;
        return this;
    }

    public BuLayRelative_01 paddings(FourSizes_01 p) {
        mPaddings = p;
        return this;
    }

    public BuLayRelative_01 bgColor(int color) {
        mBgColor = color;
        return this;
    }
     ...
     * @return --
     */
    public BuLayRelative_01 appendToRight(View view) {
     ...
     * @return --
     */
    public BuLayRelative_01 lastExtraAlignV(int align) {
    ...
    public BuLayRelative_01 appendToRight(View view, boolean b) {
     ...
     * @return
     */
    public BuLayRelative_01 appendToLeft(View... view) {
        for (View elem : view) {
            appendToLeft(elem);
        }
        return this;
    ...
    public BuLayRelative_01 drawer(N1208_AbsDrawer drawer) {
        mDrawer = drawer;
        return this;
    }

    public BuLayRelative_01 margins(FourSizes_01 fourSizes) {
        mMargins = fourSizes;
        return this;
    }

    public BuLayRelative_01 classLayParams(Class<?> c) {
        mLayParamsClass = c;
        return this;
    }

    public BuLayRelative_01 hMP() {
    ...
    public BuLayRelative_01 appendToLeft(View view, boolean b) {
     ...
     * @return --
     */
    public BuLayRelative_01 addBaseView(View view) {
        if (view == null) return this;
        //===
        _rl.addView(view);
        NRelativeLayout.LayoutParams lp = (NRelativeLayout.LayoutParams) view.getLayoutParams();
     ...
     * @return --
     */
    public BuLayRelative_01 lastMarginR(int dp) {
        if (mLastInvoked != null && mLastInvoked == ESide.LEFT && mLViews.length > 0) {
            NRelativeLayout.LayoutParams lp = (NRelativeLayout.LayoutParams) mLViews[mLViews.length - 1].getLayoutParams();
     ...
     * @return --
     */
    public BuLayRelative_01 lastMarginL(int dp) {
        if (mLastInvoked != null && mLastInvoked == ESide.LEFT && mLViews.length > 0) {
            NRelativeLayout.LayoutParams lp = (NRelativeLayout.LayoutParams) mLViews[mLViews.length - 1].getLayoutParams();
