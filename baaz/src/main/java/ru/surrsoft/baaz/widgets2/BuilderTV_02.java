 ...
 * <p>
 * ОПЦИИ:
 * -- текст можно задавать методами {@link #text(CharSequence)}, {@link #textLineAdd(CharSequence)}
...
public class BuilderTV_02 {
  ...
  //==============================================================================================
  public BuilderTV_02(Context context) {
    mContext = context;
    _tv = new NTextView(context);
  }

  public interface Get {
    void f(TextView tv, BuilderTV_02 bu);
  }
  ...
  public BuilderTV_02 owet(String owet) { //[ecud]
    mOwet = owet;
    return this;
  }
   ...
   * @return --
   */
  public BuilderTV_02 gefp(String gefp) {
    mGefp = gefp;
    return this;
  }

  public BuilderTV_02 enable(boolean b) {
    mEnable = b;
    return this;
  }

  public BuilderTV_02 marginR(int dp) {
    mMarginR_dp = dp;
    return this;
  }

  //[ecud]
  public BuilderTV_02 ecudComment(String st) {
    mEcudComment = st;
    return this;
  }

  public BuilderTV_02 text(CharSequence text) {
    mText = text;
    return this;
  }

  /**
   * {возможен многократный вызов}
   * <p>
   * Добавляемые этим методом строки добавляется (через перенос строки) к тексту заданному с помощью
   * метода {@link #text(CharSequence)}
   *
   * @param textLine (1) -- null-строка будет проигнорирована; пустые строки допустимы
   * @return --
   */
  public BuilderTV_02 textLineAdd(CharSequence textLine) {
    if (textLine != null) {
      String stDiv = "\n";
      //---
      if (mText == null) {
      ...
      //---
      mText = mText + stDiv + textLine;
    }
    return this;
  }

  public BuilderTV_02 textColor(int color) {
    bTextColor = true;
    mTextColor = color;
    return this;
  }

  public BuilderTV_02 textColor(ColorStateList csl) {
    bTextColorCSL = true;
    mTextColorCSL = csl;
    return this;
  }
   ...
   * @return
   */
  public BuilderTV_02 textSize(int sp) {
    mFontSize_sp = sp;
    return this;
  }
  ...
  public BuilderTV_02 paddingL(int dp) {
    mPaddingL_px = G67G_Draw.px(dp);
    return this;
  }

  public BuilderTV_02 paddingT(int dp) {
    mPaddingT_px = G67G_Draw.px(dp);
    return this;
  }

  public BuilderTV_02 paddingR(int dp) {
    mPaddingR_px = G67G_Draw.px(dp);
    return this;
  }

  public BuilderTV_02 paddingB(int dp) {
  ...
  public BuilderTV_02 paddings(int dp) {
  ...
  public BuilderTV_02 paddings(int l_dp, int t_dp, int r_dp, int b_dp) {
  ...
  public BuilderTV_02 margins(int l_dp, int t_dp, int r_dp, int b_dp) {
    mMarginL_dp = l_dp;
    mMarginT_dp = t_dp;
    mMarginR_dp = r_dp;
    mMarginB_dp = b_dp;
   ...
   * @return --
   */
  public BuilderTV_02 underline(boolean b) {
    mIsUnderline = b;
    return this;
  }

  public BuilderTV_02 bold(boolean b) {
    mIsBold = b;
    return this;
  }

  public BuilderTV_02 italic(boolean b) {
    mIsItalic = b;
    return this;
  }

  public BuilderTV_02 textColorPressed(int c) {
    mColorPressed = c;
    return this;
  }

  public BuilderTV_02 pressViewAnimation(Animation anim) {
    mPressViewAnimation = anim;
    return this;
  }

  public BuilderTV_02 pressViewAnimation(@AnimRes int resAnim) {
   ...
   * @return --
   */
  public BuilderTV_02 singleChoice(String[] elems,
                                   String textNoSelect,
   ...
   * @return
   */
  public BuilderTV_02 singleChoice2(Zvah zvah, String keySharPref, UniPresenter<String> uniPresenter) {
  ...
  public BuilderTV_02 bgColor(int color) {
    mBgColor = color;
    return this;
  }

  public BuilderTV_02 textFont(Typeface tf) {
    mTypeface = tf;
    return this;
  }
   ...
   * @return
   */
  public BuilderTV_02 fontSize(int sp) {
    mFontSize_sp = sp;
    return this;
  }

  public BuilderTV_02 twocolors(TwoColors tc) {
    mTC_ = tc;
    return this;
  }

  public BuilderTV_02 addTo(ViewGroup lay) {
    mLayParent = lay;
    return this;
  }
   ...
   * @return --
   */
  public BuilderTV_02 gravitySelf(int g) {
    mGravitySelf = g;
    return this;
  }
   ...
   * @return --
   */
  public BuilderTV_02 gravityIn(int g) {
    mGravityIn = g;
    return this;
  }
   ...
   * @return
   */
  public BuilderTV_02 drawer(N1208_AbsDrawer drawer) {
    mDrawer = drawer;
  ...
  public BuilderTV_02 wMP() {
    mW_px = ViewGroup.LayoutParams.MATCH_PARENT;
    return this;
  }

  public BuilderTV_02 hMP() {
   ...
   * @return --
   */
  public BuilderTV_02 isPicker(EFcar etypedata,
                               String startValue,
                               String valueIfEmpty,
   ...
   * @return
   */
  public BuilderTV_02 isCheckbox(boolean checked, UniPresenter<Ret2_j_bo> presenter) {
    mCheckedIs = true;
    mChecked = checked;
  ...
  public BuilderTV_02 tag(Object oj) {
    mTag = oj;
    return this;
  }

  public BuilderTV_02 onclick(View.OnClickListener lst) {
    mOnClick = lst;
    return this;
  }
   ...
   * @return --
   */
  public BuilderTV_02 onclick_B(boolean condition, View.OnClickListener lst) {
    if (condition) {
      onclick(lst);
    }
    return this;
  ...
  public BuilderTV_02 layParamClass(Class<?> c) {
    mLayParamClass = c;
    return this;
  }

  public BuilderTV_02 textStyle(BuTextStyle bu) {
    mTxtStyle = bu;
    return this;
  }

  public BuilderTV_02 wh(int wh_dp) {
    mW_px = G67G_Draw.px(wh_dp);
    mH_px = G67G_Draw.px(wh_dp);
    return this;
  }

  public BuilderTV_02 linkView(View[] views) {
    mLinkViews = views;
    return this;
  }

  public BuilderTV_02 linkView2(View[] views) {
    mLinkViews2 = views;
    return this;
  }

  public BuilderTV_02 linkView3(Trans<TextView> trans) {
    mTrans = trans;
    return this;
  }

  public BuilderTV_02 linkBu(BuilderTV_02[] bus) {
    mBus = bus;
    return this;
  }


  public BuilderTV_02 tag2(Object oj) {
    mTag2 = oj;
    return this;
  }
  ...
  public BuilderTV_02 w(int dp) {
    mW_px = G67G_Draw.px(dp);
    return this;
  }

  public BuilderTV_02 h(int dp) {
    mH_px = G67G_Draw.px(dp);
    return this;
  }

  public BuilderTV_02 wMin(int dp) {
    mWMin_px = U.px(dp);
    return this;
  }
   ...
   * @return --
   */
  public BuilderTV_02 confirmDialog(BuDialogConfirm bdc) {
    mConfirmDialog = bdc;
    return this;
  }

  public BuilderTV_02 popupMenu(BuPopupMenu bpm) {
    mPopupMenu = bpm;
    return this;
  }
    ...
    if (mText != null && mText.length() > 0) {
      if (mText instanceof Spannable) {
        ...
        if (mIsUnderline || mIsBold || mIsItalic) {
          ...
          if (mIsBold) {
            sps.setSpan(new StyleSpan(Typeface.BOLD), 0, sps.length(), 0);
          }
          if (mIsItalic) {
            sps.setSpan(new StyleSpan(Typeface.ITALIC), 0, sps.length(), 0);
          }
          _tv.setText(sps);
        } else {
          _tv.setText(mText);
